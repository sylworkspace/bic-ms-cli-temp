...
// 版本信息
bicMs.version = Number(Vue.version.split('.')[0])

// 模板处理
bicMs.$compile = function (template, options) {
    return _.template(template)(options)
}

bicMs.$assign = function (basic, options) {
...
bicMs.creatApp = function (options = {}) {
    let basic = {
    ...
    return bicMs.$assign(basic, options)

}


export default bicMs
